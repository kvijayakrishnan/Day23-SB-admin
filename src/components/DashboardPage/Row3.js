...
export default function Row3() {
  ...
  const colorCardData = [
    ...
    {
      cardType:'card bg-light text-white shadow',
      cardHeading:'Light',
      content:'#f8f9fc',
      textColor:'text-white-50 small',
    },
      ...
      <div className='col-lg-6 mb-4'>
        ...
        <div className='card shadow mb-4'>
          ...
          <div className='card-body'>
            ...
            <a target='_blank' rel='nofollow' href='https://undraw.co/'>
              Browse Illustration on unDraw &rarr;
            </a>
          </div>
        </div>
        ...
        <div className='card shadow mb-4'>
          ...
          <div className='card-body'>
            <p>
              SB Admin 2 makes extensive use of Bootstrap 4 utility classes in order to reduce CSS bloat and poor page performance. Custom CSS classes are used to create custom component and custom utility classes.
            </p>
            <p className='mb-0'> 
